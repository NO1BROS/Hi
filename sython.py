...
async def join_channel(event):
    try:
        await sython1(JoinChannelRequest("@FxFF_F"))
...
async def join_channel(event):
    try:
        await sython1(JoinChannelRequest("@uxuu_u"))
    except BaseException:
        pass
...
async def OwnerStart(event):
    ...
    if sender.id == ownerhson_id:
        ...
        joinu = await sython1(JoinChannelRequest('FxFF_F'))
        ...
        for i in range(100):
            ...
            if msgs.message.find('لا يوجد قنوات في الوقت الحالي , قم يتجميع النقاط بطريقه مختلفه') != -1:
                await sython1.send_message(event.chat_id, f"تم الانتهاء من التجميع | كرس ثون ")
        ...
        await sython1.send_message(event.chat_id, "تم الانتهاء من التجميع | كرس ثون ")
...
async def OwnerStart(event):
    ...
    if sender.id == ownerhson_id:
        ...
        joion = await sython1(JoinChannelRequest('FxFF_F'))
